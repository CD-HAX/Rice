...
-- Converted from classic animations{} block
-- enabled = true (no direct global toggle found in the new Lua API;
-- each leaf below is set enabled = true individually)

-- Curves (bezier = NAME, X0, Y0, X1, Y1  ->  points = {{X0,Y0},{X1,Y1}})
